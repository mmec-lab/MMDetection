...
def pytorch2libtorch(model,
    ...
    """
    if isinstance(model.roi_head.bbox_head, nn.ModuleList):
        num_classes = model.roi_head.bbox_head[-1].num_classes
    else:
...
def parse_args():
    ...
    parser.add_argument('--output-file', type=str, default='tmp.tr')
